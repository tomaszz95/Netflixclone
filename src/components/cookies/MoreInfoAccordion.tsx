        ...
        <div className={styles.accordion}>
            ...
            <div className={`${styles.accordionText} ${activeAccordion === 0 ? 'openCookieText' : ''}`}>
                ...
                <p>
                    ...
                    device, for what purposes they use such information, and how you can control the use of cookies for
                    non-essential activities.
                </p>
                <br />
                <p>
                    Netflix adheres to the Self-Regulatory Principles for Online Behavioral Advertising of the Digital
                ...
                <br />
                <p>
                    You who opt-out of advertising cookies may continue to be presented with Netflix ads, but they will
                    not be personalized by Netflix or our service providers. In addition, Netflix will continue to
                    personalize your use of the site with cookies that you have consented to.
                </p>
                <br />
                <p>
                    In most browsers, you can also configure your privacy settings to prevent the acceptance of new
                    cookies, receive notifications when a new cookie is received, or disable cookies altogether. If the
                    browser is set to reject all cookies, the User will not receive behavioral advertising, but this may
                    adversely affect the use of Netflix or prevent it altogether. In addition, if the User has used
                    Netflix's cookie management tool to opt out of certain cookies, such settings will be remembered in
                    a cookie stored on the User's device. Therefore, in order for the User's preferences to be saved, it
                    is important that the User's browser configuration allows the use of cookies. If the User deletes or
                    clears cookies or changes his browser, he must reconfigure his cookie settings.
                </p>
                <br />
                <p>
            ...
            <div className={`${styles.accordionText} ${activeAccordion === 1 ? 'openCookieText' : ''}`}>
                ...
                <p>
                    ...
                    our Service Providers may use such cookies to authenticate and identify you as you use our sites and
                    applications, allowing us to provide you with our services. They also enable us to enforce our terms
                    of use, prevent fraud and maintain security.
                </p>
                <br />
                <p>
                    Duration: most cookies are session cookies (active until you close your browser) or active for one
                    day only. Some cookies are active for longer periods of time - from 3 to 12 months. Cookies used to
                    prevent fraud and protect the security of our services are active for up to 24 months.
                </p>
            </div>
            ...
            <div className={`${styles.accordionText} ${activeAccordion === 4 ? 'openCookieText' : ''}`}>
                ...
                <p>
                    ...
                    your response to our ads and emails. They are used to deliver ads in which the user may be
                    interested and for analytics and optimization purposes. These types of ads are called
                    "interest-based ads" and are displayed to users outside the Netflix domain. Netflix uses legal and
                    technical solutions to prevent advertising partners from accessing information about the specific
                    titles you select, the URLs you visit, and the material you watch on our service. We do not share
                    information about the titles you select or the materials you view on our site. Advertising cookies
                    related to our service belong to our advertising partners. Details are provided in the cookie
                    information. Select your settings for advertising cookies below. If you want to opt out of
                    advertising cookies on all sites, go here.
                </p>
            </div>
        </div>
    )
